...
export default function CourseCard({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.8}
      className="mr-4 w-48 bg-white rounded-xl overflow-hidden shadow-sm"
    >
      ...
      <View className="p-3">
        ...
        <Text className="text-sm font-bold text-text mt-1.5 mb-2 line-clamp-2">{title}</Text>
        ...
        <Text className="text-sm font-bold text-text">{price}</Text>
      </View>
    </TouchableOpacity>
  );
}
